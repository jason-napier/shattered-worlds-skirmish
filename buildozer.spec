...
title = Shattered Worlds Skirmish

# (str) Package name
package.name = shatteredworlds

# (str) Package domain (needed for android/ios packaging)
package.domain = org.shatteredworlds
...
requirements = python3,kivy==2.2.1,pillow==10.0.0
...
# (bool) Indicate that the application should support background fetch
#tvos.background_modes = 0
